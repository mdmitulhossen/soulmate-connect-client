...
function Navbar(props) {
    ...
    return (
        <Container disableGutters maxWidth='xl' sx={{ px: { xl: '0px', lg: '50px', md: '30px', sm: '20px', sz: '10px' }, border: 1 }}>
            {/* <CssBaseline /> */}
            <AppBar elevation={0} component="nav" sx={{ bgcolor: '#FEFBF3', color: '#66451c', py: 1 }} position='sticky'>
