...
const ManageContactRequest = () => {
    ...
    const handleApprovedContactClick = (B_ID) => {
        // Implement your logic to mark the contact as approved based on B_ID
        console.log(`Approved Contact clicked for B_ID: ${B_ID}`);
    };
    return (
        <div>
            <Typography
                                            ...
                                            {columns.map((column) => {
                                                ...
                                                return (
                                                    <TableCell key={column.id} align={column.align}>
                                                        {column.id === 'action' ? (
                                                            <Chip onClick={() => handleApprovedContactClick(row.B_ID)} label="Approved Contact" color="primary" size='small' />
                                                        ) : (
